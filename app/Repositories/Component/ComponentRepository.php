...
use App\Models\Component\ComponentContent;

class ComponentRepository extends BaseRepository implements BaseRepositoryInterface
{
    ...
    public function __construct()
    {
        ...
        $this->contentModel = new ComponentContent();
    }
    ...
    public function updateContent($componentId, $content)
    {
        ...
        $this->contentModel->where('component_id', $componentId)
    ...
    public function getOneContent($componentId, $fieldId)
    {
        return $this->contentModel->where('component_id', $componentId)->where('content_type_field_id', $fieldId)->first();
    }
    ...
    private function selectRelationData($query, $params)
    {
        $query = $query->with(['contentValue' => function ($contentValue) use ($params) {
            $contentValue->select('id', 'component_id', 'content_type_field_id', 'value', 'localization_id');
