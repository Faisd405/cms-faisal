<template>
    ...
    >
        ...
        >
            <svg
                class="h-4 w-4 fill-current text-slate-400 dark:text-slate-500"
                viewBox="0 0 16 16"
            >
                <path
        ...
        <div class="absolute z-10" :class="positionOuterClasses(position)">
            <transition
            ...
            >
                <div
                    v-show="tooltipOpen"
                    class="overflow-hidden rounded border shadow-lg"
                    :class="[
                        colorClasses(bg),
                        sizeClasses(size),
