...
const deleteContent = () => {
    axios
        .delete(`/collection/sections/${tempId.value}`)
        .then(() => {
...
<template>
    <AppLayout title="Content Sections">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="whitespace-normal px-6 py-4">
                                        ...
                                        >
                                            <a
                                                :href="`/collection/sections/${item.id}/posts`"
                                            ...
                                            <a
                                                :href="`/collection/sections/${item.id}/edit`"
        ...
        <FwbModal v-if="isShowDeleteModal" @close="isShowDeleteModal = false">
            <template #header> Delete Content </template>
            <template #body>
