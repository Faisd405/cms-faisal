...
import FormModal from '@/Components/Partials/Component/FormModal.vue'
...
const deleteComponent = () => {
    axios
        .delete(`/components/${tempId.value}`)
        .then(() => {
...
<template>
    <AppLayout title="Components">
        <template #header>
            <div class="flex justify-between">
                ...
                <div>
                    ...
                    >
                        <i class="ion ion-md-add"></i> Add Component
                    </button>
                </div>
            </div>
        </template>
        ...
        <FwbModal v-if="isShowDeleteModal" @close="isShowDeleteModal = false">
            <template #header> Delete Component </template>
            <template #body>
