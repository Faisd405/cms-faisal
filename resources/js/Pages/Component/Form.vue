        ...
        <div class="mt-8 md:col-span-2">
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-4">
                    <FormContent
                        :item="components"
                        :update-url="`/components/${props.item.id}/content`"
                    ...
                    <div class="mb-4 bg-white shadow sm:rounded-md">
                        <div class="px-4 py-5 sm:px-6">
                            ...
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                Component information and settings.
                            </p>
                        </div>
...
function changeLanguage(locale) {
    const url = `/components/${props.item.id}/edit?locale=${locale}`
    window.location = url
}

onBeforeMount(() => {
    components.value = props.item
